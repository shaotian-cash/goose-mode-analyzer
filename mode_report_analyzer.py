...
Usage:
    python mode_report_analyzer.py <mode_report_url>
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python mode_report_analyzer.py <mode_report_url>")
        print("\nExample:")
        print("  python mode_report_analyzer.py https://app.mode.com/cashapp/reports/92b253c1af84")
